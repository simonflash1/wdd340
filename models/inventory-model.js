...
async function getDetailsById(inv_id) {
  try {
    ...
    console.error(error + "at getDetailsById");
  }
}
...
module.exports = {getClassifications, getInventoryByClassificationId, getDetailsById, addClassification, checkExistingClassification, addInventory, updateInventory, deleteInventoryItem}